# Seids
&nbsp;
<p>The name ‘Seids’ comes from knowing each seed we plant carries its own identity within its shape, colour and sometimes flavour; creating an ID for each. This is where ‘Seeds’ became ‘Seids’.

<p>Seids primary goal is to provide a few key tips and information for the sowing and upkeep of a large variety of plants. These range from vegtable and fruit seeds such as tomates and strawberries, to in and outdoor plants, such as snake tounges and roses. Seids contains simple but useful information for both beginners and well established gardeners in need of quick tips or reminders. Throughout, the site provides easy to view sections with clear and consise navigation. There are also useful links to social media platforms where growers can interact with other seed enthusiasts, swap tips, offer help or ask questions.</p>

<p>The colour scheme used for this site are the colours most assocaited with plants; green and brown. The green top represents leaves followed by a plain white middle for the essential content, (so it can be read easily) and finished with a brown footer to represent the soil in which plants grow. I picked the primary colours from a RGB selector tool and the other variations of the colours come from those two colours. The greens HEX is #53BF9F and the brown is #725647 meaning enough colour contrast between the two elements when scrolling down a short page. You can also see from the image provided the different viewport sizes on multiple screens.</p>
<br><br>
